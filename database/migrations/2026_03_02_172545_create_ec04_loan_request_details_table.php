...
class CreateEc04LoanRequestDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ec04_loan_request_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ec04_loan_request_details');
    }
}
