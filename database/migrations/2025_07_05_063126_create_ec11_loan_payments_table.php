...
class CreateEc11LoanPaymentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('ec11_loan_payments', function (Blueprint $table) {
            ...
            $table->double('payment_total_amount', 15, 2)->nullable();
            $table->date('payment_date')->nullable();
            $table->enum('payment_method', ['cash', 'bank', 'upi', 'other'])->nullable();
            $table->boolean('is_paid')->default(false);
            $table->double('principal_balance_amount_before_payment', 15, 2)->nullable();
            $table->double('principal_balance_amount_after_payment', 15, 2)->nullable();
