<div class="p-4">
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="px-4 py-3 border-b border-gray-200 flex justify-between items-center">
            <h3 class="text-lg font-semibold text-gray-700">SHFUND Member Specifications</h3>
                ...
                <table class="min-w-full text-sm">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-3 py-2 text-left font-medium text-gray-600">Member Master</th>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse ($specs as $spec)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-3 py-2">{{ $spec->memberMasterDb->name ?? '-' }}</td>
                                <td class="px-3 py-2">
                                    @switch($spec->status)
                                        @case('draft')
