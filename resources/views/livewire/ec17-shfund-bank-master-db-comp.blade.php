<div class="p-4">
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="px-4 py-3 border-b border-gray-200 flex justify-between items-center">
            <h3 class="text-lg font-semibold text-gray-700">SHFUND Bank Master</h3>
                ...
                <table class="min-w-full text-sm">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-3 py-2 text-left font-medium text-gray-600">Operational Amount</th>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse ($masterDbs as $masterDb)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-3 py-2">{{ $masterDb->bank->name ?? '-' }}</td>
                                <td class="px-3 py-2">
                                    @if($masterDb->bank_share_operational_type)
                                        <span class="px-2 py-1 text-xs rounded {{ $masterDb->bank_share_operational_type === 'deposit' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700' }}">
                                ...
                                <td class="px-3 py-2">{{ $masterDb->bank_share_operational_amount ? number_format($masterDb->bank_share_operational_amount, 2) : '-' }}</td>
                                <td class="px-3 py-2">{{ $masterDb->bank_share_current_balnce ? number_format($masterDb->bank_share_current_balnce, 2) : '-' }}</td>
                                <td class="px-3 py-2">
                ...
                <div class="p-4">
                    <form>
                        ...
                        <div class="grid grid-cols-4 gap-3 mt-3">
                            <div>
                                <label class="block text-xs font-medium text-gray-600 mb-1">Loan Previous Balance</label>
                                <input type="number" step="0.01" class="w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:border-blue-500" wire:model="bank_loan_previous_balnce" placeholder="0.00">
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-600 mb-1">Share Previous Balance</label>
                                <input type="number" step="0.01" class="w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:border-blue-500" wire:model="bank_share_previous_balnce" placeholder="0.00">
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-600 mb-1">Operational Type</label>
                                <select class="w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:border-blue-500" wire:model="bank_share_operational_type">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" class="w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:border-blue-500" wire:model="bank_share_operational_amount" placeholder="0.00">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-3 gap-3 mt-3">
                            <div>
                                ...
                                <input type="date" class="w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:border-blue-500" wire:model="bank_share_operational_date">
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-600 mb-1">Current Balance</label>
                                <input type="number" step="0.01" class="w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:border-blue-500" wire:model="bank_share_current_balnce" placeholder="0.00">
                            </div>
                            <div>
