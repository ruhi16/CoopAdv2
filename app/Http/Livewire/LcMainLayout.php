...
class LcMainLayout extends Component
{
    ...
    public $menuItems = [
        ...
        'loans_to_members' => [
            'label' => 'Loans to Members',
            'icon' => 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z',
        ],
        'bank_loans_borrowed' => [
            'label' => 'Bank Loans Borrowed',
            'icon' => 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z',
        ],
        'thrift_fund' => [
            'label' => 'Thrift Fund',
        ...
        'member_loan_payments' => [
            'label' => 'Member Loan Payments',
            'icon' => 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z',
        ],
        'bank_borrowed_loan_payments' => [
            'label' => 'Bank Loan Payments',
            'icon' => 'm9 3H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 3a2 2 0 012-2h2a2 2 0 012 2M9 3a2 2 0 012-2h2a2 2 0 012 2z',
        ],
    ];
