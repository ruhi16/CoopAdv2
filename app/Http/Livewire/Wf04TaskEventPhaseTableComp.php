...
class Wf04TaskEventPhaseTableComp extends Component
{
    use WithPagination;
    ...
    private function getAvailableModels()
    {
        ...
        foreach ($files as $file) {
            ...
            if ($className !== 'User' && $className !== 'Role' && $className !== 'School') {
                $models[] = $className;
            }
        }
        sort($models);
    ...
    public function render()
    {
        ...
        return view('livewire.wf04-task-event-phase-table-comp', compact('tableOperations'));
    }
    ...
    public function edit($id)
    {
        ...
        $this->model_name = $tableOperation->model_name;
