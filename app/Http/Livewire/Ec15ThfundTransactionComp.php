...
class Ec15ThfundTransactionComp extends Component
{
    ...
    {
        $transactions = Ec15ThfundTransaction::with(['masterDb', 'member'])
        ...
        return view('livewire.ec15-thfund-transaction-comp', compact('transactions'));
    }
    ...
    public function store()
    {
        ...
        Ec15ThfundTransaction::updateOrCreate(['id' => $this->transaction_id], array_merge($validated, [
    ...
    {
        $transaction = Ec15ThfundTransaction::findOrFail($id);
        
        $this->transaction_id = $id;
        $this->thfund_master_db_id = $transaction->thfund_master_db_id ?? '';
    ...
    {
        Ec15ThfundTransaction::find($id)->delete();
        $this->confirmingDelete = null;
